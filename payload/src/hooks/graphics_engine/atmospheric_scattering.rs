...
//! makes it the second consumer of the [`crate::hooks::graphics_engine::reconstruction`] basis after the deferred resolve,
...
//! deferred resolve already split per eye ([`crate::hooks::graphics_engine::clustered_lighting`]) -- the cascade is sampled in
