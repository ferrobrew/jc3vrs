...
use crate::{
    ...
    rewrite::common::{
        ...
        SIGNATURE_SYSVALUE_VIEWPORT_ARRAY_INDEX, STEREO_CB_REGISTER, STEREO_CB_ROWS,
        SignatureElement, append_signature_element, declared_register, max_signature_register,
        reassemble,
    },
    tokens::{
